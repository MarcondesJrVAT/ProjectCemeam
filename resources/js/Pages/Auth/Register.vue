            ...
            <div class="grid gap-6">
                <div class="space-y-2">
                    ...
                    <InputIconWrapper>
                        ...
                        <Input withIcon id="name" type="text" placeholder="Nome" class="block w-full" v-model="form.name" required autofocus autocomplete="name" />
                    </InputIconWrapper>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <InputIconWrapper>
                        ...
                        <Input withIcon id="email" type="email" class="block w-full" placeholder="E-mail" v-model="form.email" required autocomplete="username" />
                    </InputIconWrapper>
                </div>
                ...
                <div class="space-y-2">
                    <Label for="password_confirmation" value="Confirme Senha" />
                    <InputIconWrapper>
                        <template #icon>
                            <LockClosedIcon aria-hidden="true" class="w-5 h-5" />
                        </template>
                        <Input withIcon id="password_confirmation" type="password" class="block w-full" placeholder="Confirme Senha" v-model="form.password_confirmation" required autocomplete="new-password" />
                    </InputIconWrapper>
                </div>
